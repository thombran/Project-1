...
public class SimpleDate {
    ...
    /**
     * Default constructor. Sets the date to January 1, 1753 as the default date
     */
    public SimpleDate() {
        month = 01;
        day = 01;
    ...
    public int compareTo(SimpleDate other) {
        if (other != null) {
            if (this.greaterMDY(other))
                return 1;
            else if (this.lesserMDY(other))
                return -1;
    ...
    public void load(String fileName) throws IllegalArgumentException {
        SimpleDate s = new SimpleDate(); //TODO Anything else to complete with this method?
        try {
