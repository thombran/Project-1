...
public class SimpleDate {
    public static SimpleDate jDate = new SimpleDate();
    /**
    ...
    public void load(String fileName) throws IllegalArgumentException {
        ...
        try {
            ...
            jDate.month = scnr.nextInt();
            jDate.day = scnr.nextInt();
            jDate.year = scnr.nextInt();
        } catch (Exception e) {
            throw new IllegalArgumentException();
        }
        s.setMonth(jDate.getMonth());
        s.setDay(jDate.getDay());
        s.setYear(jDate.getYear());
